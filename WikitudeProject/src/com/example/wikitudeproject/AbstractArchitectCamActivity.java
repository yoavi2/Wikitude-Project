...
public abstract class AbstractArchitectCamActivity extends Activity implements ArchitectViewHolderInterface{
	...
	public void onCreate( final Bundle savedInstanceState ) {
		...
		final ArchitectConfig config = new ArchitectConfig( this.getWikitudeSDKLicenseKey(), this.getARMode() );
...
//						}
	...
	private int getARMode() {
		int arMode = (hasGeo() ? ARMode.GEO : 0) | (hasIR() ? ARMode.IR : 0);
		return arMode;
	}
